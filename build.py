...
<nav aria-label="목차"><a href="portfolio.html">다른 업체 포트폴리오</a><a href="review.html">결과물 정밀 검토</a><a href="#shortlist">후보 비교</a><a href="#basis">현재 설계</a><a href="#verify">검증 기준</a><a href="#quote">견적 준비</a><a href="#sources">근거·한계</a><a href="history/archive.html">이전 논의</a></nav><main>
