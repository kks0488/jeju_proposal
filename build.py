...
<nav aria-label="목차"><a href="review.html">결과물 정밀 검토</a><a href="#shortlist">후보 비교</a><a href="#basis">현재 설계</a><a href="#verify">검증 기준</a><a href="#quote">견적 준비</a><a href="#sources">근거·한계</a><a href="history/archive.html">이전 논의</a></nav><main>
...
<h3>평가 배점 · 업체 점수는 아직 부여하지 않음</h3>'''+table(['항목','배점','증거'],D['weights'])+'''<p>평가 등급 0–5를 정하고 <b>배점 × 등급 ÷ 5</b>로 환산합니다. 0은 미충족 확인, 3은 요구 충족, 5는 반복 실적과 현장 검증까지 우수한 경우입니다. <b>미검증은 빈칸</b>으로 두고 총점 순위를 매기지 않습니다.</p><a class="button" href="templates/contractor-evaluation.csv" download>평가표 CSV 받기</a></section>
