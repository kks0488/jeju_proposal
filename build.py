...
with (R/'templates/contractor-evaluation.csv').open('w',encoding='utf-8-sig',newline='') as f:
 ...
 for c in [*D['candidates'],{'name':'대오종합건설'}]:
...
<nav aria-label="목차"><a href="folio-audit.html">폴리오·공정 평가</a><a href="ranking.html">점수·순위</a><a href="portfolio.html">다른 업체 포트폴리오</a><a href="review.html">결과물 정밀 검토</a><a href="#shortlist">후보 비교</a><a href="#basis">현재 설계</a><a href="#verify">검증 기준</a><a href="#quote">견적 준비</a><a href="#sources">근거·한계</a><a href="history/archive.html">이전 논의</a></nav><main>
...
<h3>계약 전 현장 평가표 · 공개자료 채점과 별도</h3>'''+table(['항목','배점','증거'],D['weights'])+'''<p>아래는 향후 현장·견적 검증용 평가표입니다. 현재 공개자료의 근거 점수는 <a href="ranking.html">별도 채점표</a>에 있습니다. 사전 기여는 <a href="folio-audit.html">0~3점 기준</a>을 직접 적용합니다. 나머지 항목은 현장 평가 등급 0–5를 정하고 <b>배점 × 등급 ÷ 5</b>로 환산합니다. 0은 미충족 확인, 3은 요구 충족, 5는 반복 실적과 현장 검증까지 우수한 경우입니다. <b>미검증은 빈칸</b>으로 두고 총점 순위를 매기지 않습니다.</p><a class="button" href="templates/contractor-evaluation.csv" download>평가표 CSV 받기</a></section>
...
runpy.run_path(str(R/"build_folio_audit.py"))
